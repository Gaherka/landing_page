...
function Experience() {
    return (
        <div id='Caracteristicas' className="experience flex flex-col items-center justify-start px-[5rem] bg-[#020917] h-[40rem] pt-[13rem] mt-[-10rem] relative z-[2] rounded-b-[3rem]">
            {/* icon */ }
