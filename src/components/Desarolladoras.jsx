...
return(
    <div id="Desarolladoras" className="desarrolladoras flex flex-col items-center justify-start px-[5rem] bg-[#081730] h-[40rem] pt-[13rem] mt-[-10rem] relative z-[-1] rounded-b-[3rem]">
            {/* icon */ }
